                    ...
                    <tr>
                        ...
                        <td class="title column-message has-row-actions column-primary page-title" data-colname="留言信息">
                            ...
                            <div class="row-actions">
                                <span class="edit"><a href="?page=<?=$_GET['page']?>&action=reduction&id=<?=$v['rowid']?>" aria-label="还原">还原</a> | </span>
                                <span class="trash"><a href="?page=<?=$_GET['page']?>&action=delete&id=<?=$v['rowid']?>" class="submitdelete" aria-label="永久删除">永久删除</a></span>
                            </div>
                        </td>
